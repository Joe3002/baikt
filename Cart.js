...
const CartScreen = () => {
  ...
  return (
    <View >
        ...
        <Icon2 name="chevron-back" size={40} color="orange" />
        </TouchableOpacity>
        <View style={{marginTop: 150, marginLeft: 20,marginBottom:30}}>
            ...
            <View style={{ flexDirection: 'row'}}>
              <Image source={require('../assets/anh3.png')} style={{margin: 10}}/>
                <View  style={{margin: 10, marginLeft: 30}}>
                    ...
                    <Text style={{color: 'orange'}}><Icon name='dollar'/> 149          <Text>                     </Text>                         
                    <Icon name='minus' style={{marginLeft: 100}}/><Text style={{color:'black'}}>  2  </Text><Icon name='plus'/></Text>
                </View>
              </View>
            </View>
        </View>
            ...
            <View style={{ flexDirection: 'row'}}>
              <Image source={require('../assets/anh4.png')} style={{margin: 10}}/>
                <View  style={{margin: 10, marginLeft: 30}}>
                    ...
                    <Text style={{color: 'orange'}}><Icon name='dollar'/> 129 <Text>                               </Text>
                    <Icon name='minus' style={{marginLeft: 100}}/><Text style={{color:'black'}}>  2  </Text><Icon name='plus'/></Text>
                </View>
              </View>
            </View>
            ...
            <View style={{ flexDirection: 'row'}}>
              <Image source={require('../assets/anh5.png')} style={{margin: 10}}/>
                <View  style={{margin: 10, marginLeft: 30}}>
                    ...
                    <Text style={{color: 'orange'}}><Icon name='dollar'/> 1249       <Text>                       </Text>
                    <Icon name='minus' style={{marginLeft:140}}/><Text style={{color:'black'}}>  2  </Text><Icon name='plus'/></Text>
                </View>
              </View>
            </View>
        </View>
        <View>
            <View style={{flexDirection:'row'}}>
              ...
              <Text style={{marginLeft: 200,marginTop: 20, fontSize: 20, fontWeight: 'bold', color:'orange'}}><Icon name='dollar'size={20}/>1,527</Text>
            </View>
